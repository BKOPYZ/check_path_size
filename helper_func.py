...
def __get_directory_size_depth_reach(pathfile: str)->float: # TODO: fix this shit
    size = 0.0
    pathfile = Path(pathfile)
...
def __get_path_properties(pathfile: Path, pos: int, depth: int) -> List[PathProperties]: # TODO: fix this shit
    """
    """
    global size
    if Path(pathfile).is_file():
        ...
        pathprop = [PathProperties(pathfile,directory_size , PathType.DIRECTORY)]
